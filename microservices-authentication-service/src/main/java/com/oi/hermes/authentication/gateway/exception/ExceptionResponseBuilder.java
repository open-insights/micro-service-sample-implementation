...
import com.oi.hermes.authentication.gateway.exception.model.Links;
...
public class ExceptionResponseBuilder {
	...
	/**
	 * Methods returns link which is rest API. Api response of error code
	 * information and troubleshoot steps
	 * 
	 * @param errorCode
	 * @param req
	 * @return Links
