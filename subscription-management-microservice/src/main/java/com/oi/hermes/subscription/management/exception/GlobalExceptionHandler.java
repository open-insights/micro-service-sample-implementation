...
import com.oi.hermes.subscription.management.exception.model.APIExceptionResponse;
import com.oi.hermes.subscription.management.exception.type.CustomFeignClientException;
import com.oi.hermes.subscription.management.exception.type.EntityAlreadyPresentException;
import com.oi.hermes.subscription.management.exception.type.GeneralException;
import com.oi.hermes.subscription.management.exception.type.InvalidCredentialsException;
import com.oi.hermes.subscription.management.exception.type.ResourceNotAcceptableException;
import com.oi.hermes.subscription.management.exception.type.ResourceNotModifiedException;
...
@RestControllerAdvice(basePackages = { "com.oi.hermes.subscription.management.dao",
		"com.oi.hermes.subscription.management.controller",
		"com.oi.hermes.subscription.management.security.controller" }, basePackageClasses = RepositoryRestExceptionHandler.class)
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleNetflixClientException(ClientException ex) {
		APIExceptionResponse apiExceptionResponse = exceptionResponseBuilder.buildExceptionResponse(ex,
				String.valueOf(HttpStatus.NOT_FOUND.value()), ex.getMessage(),
				trace.currentSpan().context().traceIdString(), HttpStatus.NOT_FOUND);
		return new ResponseEntity<Object>(apiExceptionResponse, HttpStatus.NOT_FOUND);
	...
	protected ResponseEntity<Object> handleCustomFeignClientException(CustomFeignClientException ex) {
		APIExceptionResponse apiExceptionResponse = exceptionResponseBuilder.buildExceptionResponse(ex,
				String.valueOf(HttpStatus.valueOf(ex.status())), ex.getMessage(),
				trace.currentSpan().context().traceIdString(), HttpStatus.valueOf(ex.status()));
		return new ResponseEntity<Object>(apiExceptionResponse, HttpStatus.valueOf(ex.status()));
